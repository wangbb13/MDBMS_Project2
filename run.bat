...
for %%x in (corr inde) do (
    ...
    rem python is_same.py .\results\%%x_6_g1.txt .\results\%%x_6_g2.txt
    rem python is_same.py .\results\%%x_6_g2.txt .\results\%%x_6_g3.txt
    rem python is_same.py .\results\%%x_6_g3.txt .\results\%%x_6_g4.txt
    rem echo ================== %%x 6D END ============================
    rem echo.
    ...
    .\main .\datasets\%%x_8.txt .\results\%%x_8_g1.txt 3 1
    .\main .\datasets\%%x_8.txt .\results\%%x_8_g2.txt 3 2
    .\main .\datasets\%%x_8.txt .\results\%%x_8_g3.txt 3 3
    .\main .\datasets\%%x_8.txt .\results\%%x_8_g4.txt 3 4
