...
for %%x in (corr inde anti) do (
    ...
    python is_same.py .\results\%%x_8_g1.txt .\results\%%x_8_g2.txt
    python is_same.py .\results\%%x_8_g2.txt .\results\%%x_8_g3.txt
    python is_same.py .\results\%%x_8_g3.txt .\results\%%x_8_g4.txt
)
